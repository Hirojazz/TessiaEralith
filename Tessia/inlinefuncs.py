...
from wbb import (BOT_USERNAME, MESSAGE_DUMP_CHAT, SUDOERS
                aiohttpsession, app
                arq)
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [DEV](t.me/chahae_in) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/5b97df2f6ec4b5296771b.jpg",
            input_message_content=InputTextMessageContent(
